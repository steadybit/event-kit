...
import { EventKitError, EventListenerDescription, EventListenerList, EventListenerRequestBody } from './index';
...
export const eventListenerRequestBody: EventListenerRequestBody = {
	environment: {
...
export const eventKitError: EventKitError = {
	detail: 'd',
	instance: 'i',
	title: 't',
	type: 't'
